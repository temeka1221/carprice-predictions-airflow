"""
Модуль, содержащий DAG для Apache Airflow, который выполняет
этапы машинного обучения (обработку данных, обучение модели,
предсказания) и сохраняет результаты в файлы
"""
