"""
Этот модуль содержит логирование и импорты, которые используются в других модулях проекта
"""
...
def filter_data(df: pd.DataFrame) -> pd.DataFrame:
    """Удаляет из DataFrame столбцы, которые не нужны для обучения модели"""
    columns_to_drop = [
        'id',
        'url',
        'region',
...
def remove_outliers(df: pd.DataFrame) -> pd.DataFrame:
    """Удаляет лишние данные из DataFrame по столбцу 'year'"""

    def calculate_outliers(data):
        """Вычисляет границы интервала, в котором должны находиться данные"""
...
def create_features(df: pd.DataFrame) -> pd.DataFrame:
    """Создает новые столбцы в DataFrame на основе существующих"""
